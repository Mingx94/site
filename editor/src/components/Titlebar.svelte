<script lang="ts">
  ...
  import { tabs, toggleRail } from '$state/tabs.svelte';
  import { files, dirtyCount } from '$state/files.svelte';
  import { togglePanel } from '$state/tweaks.svelte';
  import { toggleCmd } from '$state/ui.svelte';

...
related_targets: ["src/routes/+layout.svelte","src/routes/blog/+page.svelte","src/routes/blog/[slug]/+page.svelte","src/routes/about/+page.svelte","src/routes/contact/+page.svelte","src/components/Header.svelte","src/components/Footer.svelte","src/styles/global.css","src/styles/tokens.css"]
---

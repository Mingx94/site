<script lang="ts">
  ...
  import { workspace, refreshTree } from '$lib/editor/state/workspace.svelte';
  import { postsStore, createPost, isValidSlug } from '$lib/editor/state/posts.svelte';
  import { openTab } from '$lib/editor/state/tabs.svelte';

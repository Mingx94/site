<script lang="ts">
  ...
  import { wordCount, readingTime } from '$lib/editor/util';
  import { postsStore, coverBust } from '$lib/editor/state/posts.svelte';
  import { assetUrlFor } from '$lib/editor/io/fs-access';
  import DynamicSvx from '$lib/editor/preview/DynamicSvx.svelte';

...
| Editor | `editor/AGENTS.md` | 網頁版本地 CMS（Vite + Svelte 5 + dev-only content API middleware）— 固定 workspace 為 `src/content/`，article-centric 側邊欄 + Cover 上傳，preview 共用 site 文章樣式與元件 |
